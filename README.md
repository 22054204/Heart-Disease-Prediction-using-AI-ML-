...
# Built a machine learning model using  Logistic Regression, Random Forest, XGBoost, and Neural Networks to predict heart disease  with 85-90 % accuracy. Evaluated using precision, recall, F1-score, and ROC-AUC. Visualized  results to show real-world use.
